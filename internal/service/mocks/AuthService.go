...
func (_m *AuthService) CompareHashAndPassword(password string, hash string) error {
...
func (_m *AuthService) CreateToken(secretKey string, id int) (string, error) {
...
func (_m *AuthService) GetJwtTokenByAuthHeader(authHeader string) (string, error) {
...
func (_m *AuthService) HashAndSalt(pwd string, pepper string) (string, error) {
...
func (_m *AuthService) ParseToken(accessToken string, secretKey string) (int, error) {
